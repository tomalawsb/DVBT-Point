const CACHE_NAME = 'dvbt-point-19.6-1705261625';
const CORE = ['./','./index.html','./style.css?v=19.6-1705261625','./app.js?v=19.6-1705261625','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
