const CACHE_NAME = 'dvbt-point-19-25-1905260701';
const CORE = ['./','./index.html','./style.css?v=19.25-1905260701','./app.js?v=19.25-1905260701','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
