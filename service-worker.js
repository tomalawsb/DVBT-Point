const CACHE_NAME = 'dvbt-point-19-14-1705262115';
const CORE = ['./','./index.html','./style.css?v=19.14-1705262115','./app.js?v=19.14-1705262115','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
