const CACHE_NAME = 'dvbt-point-19-13-1705261850';
const CORE = ['./','./index.html','./style.css?v=19.13-1705261850','./app.js?v=19.13-1705261850','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
