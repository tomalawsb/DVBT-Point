const CACHE_NAME = 'dvbt-point-19-15-1705262135';
const CORE = ['./','./index.html','./style.css?v=19.15-1705262135','./app.js?v=19.15-1705262135','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
