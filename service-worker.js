const CACHE_NAME = 'dvbt-point-19.5-1705261615';
const CORE = ['./','./index.html','./style.css?v=19.5-1705261615','./app.js?v=19.5-1705261615','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
