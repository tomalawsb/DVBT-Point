const CACHE_NAME = 'dvbt-point-19-31-1905260945';
const CORE = ['./','./index.html','./style.css?v=19.31-1905260945','./app.js?v=19.31-1905260945','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
