const CACHE_NAME = 'dvbt-point-19.9-1705261742';
const CORE = ['./','./index.html','./style.css?v=19.9-1705261742','./app.js?v=19.9-1705261742','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
