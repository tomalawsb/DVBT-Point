const CACHE_NAME = 'dvbt-point-19-10-1705261810';
const CORE = ['./','./index.html','./style.css?v=19.10-1705261810','./app.js?v=19.10-1705261810','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
