const CACHE_NAME = 'dvbt-point-19-12-1705261905';
const CORE = ['./','./index.html','./style.css?v=19.12-1705261905','./app.js?v=19.12-1705261905','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
