const CACHE_NAME = 'dvbt-point-19-18-1705262215';
const CORE = ['./','./index.html','./style.css?v=19.18-1705262215','./app.js?v=19.18-1705262215','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
