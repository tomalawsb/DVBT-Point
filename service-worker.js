const CACHE_NAME = 'dvbt-point-19-10-1-1705261822';
const CORE = ['./','./index.html','./style.css?v=19.10.1-1705261822','./app.js?v=19.10.1-1705261822','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
