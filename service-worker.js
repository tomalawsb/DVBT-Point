const CACHE_NAME = 'dvbt-point-19-4-1705261548';
const CORE = ['./','./index.html','./style.css?v=19.4-1705261548','./app.js?v=19.4-1705261548','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
