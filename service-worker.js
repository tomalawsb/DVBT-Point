const CACHE_NAME = 'dvbt-point-19-27-1905260750';
const CORE = ['./','./index.html','./style.css?v=19.27-1905260750','./app.js?v=19.27-1905260750','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
