const CACHE_NAME = 'dvbt-point-19-39-1007260932';
const CORE = ['./','./index.html','./style.css?v=19.39-1007260932','./app.js?v=19.39-1007260932','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png'];
