const CACHE_NAME = 'dvbt-point-19.8-1705261728';
const CORE = ['./','./index.html','./style.css?v=19.8-1705261728','./app.js?v=19.8-1705261728','./data/transmitters.json','./data/ant/index.json','./manifest.json','./assets/icon.svg'];
